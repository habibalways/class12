...
function marrizeage(ages){
    if(ages > 0 && ages < 10){
        return{
            name  : 'you are babu..aro pore biye koiro',
            status : 'success'
        };
    }else if(ages > 10 && ages < 17){
        return{
            name  : 'you are kishor..aro pore biye koiro',
            status : 'primary'
        };
    }else if(ages > 17 && ages < 30){
        return{
            name  : 'you are also jubok..your age is perfect for marrige ',
            status : 'warning'
        };
